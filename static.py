...
def notes_summary():
    ...
    st.write("""
        ...
        * The Need for Scalable Inference - My read
            * Faster Computation
            * Lower Energy Consumption
            * Chaper Operations
        * The Economics of AI - My read - why RAG will stay
        * Demnocratizing AI - OPENA AI
        * The World of Agents and Simulation - Jim Fan + my read
        * Don't Underestimate AI Robotics - My read
        * Optimization and AI - are we there yet?
        * The Interface for AI - My read
        * The Irony of AI - My read
    """)
